...
export default function OrdersClient({ orders }: { orders: Order[] }) {
  ...
  return (
    <section className="min-h-screen w-full pt-[6rem] lg:pt-[7rem] pb-[4rem] px-[1.5rem] lg:px-[3rem]">
      <div className="w-full min-h-full mx-auto flex flex-col gap-[1.5rem] lg:gap-[2rem]">

        {/* Header */}
        <div className="pb-[1.5rem]">
          <h1 className="text-[2rem] md:text-[4rem] lg:text-[5rem]">
            Orders
          </h1>
        </div>
        ...
        {/* Empty state */}
        {orders.length === 0 && (
           <div className="flex items-center justify-center h-full flex-col gap-[1.5rem]">
              <h1 className="text-center text-[1.2rem] lg:text-[2.5rem] text-black/70">
